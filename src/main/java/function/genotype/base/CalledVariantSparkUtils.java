...
public class CalledVariantSparkUtils {
    ...
    public static Dataset<Row> getCalledVariantDF() {
        ...
        return PopSpark.session.read().parquet("file:///nfs/external/igm-interns/PopSeQL/data/newdb/parquet/called_variant/part*");
    }
    ...
    public static Dataset<Row> getReadCoverageDF() {
        ...
        return PopSpark.session.read().parquet("file:///nfs/external/igm-interns/PopSeQL/data/newdb/parquet/read_coverage/part*");
    }
