...
public class CollapsingOutput extends Output {
    ...
    public Row getRow(NonCarrier noncarrier) {
        ...
        return RowFactory.create(
                ...
                FormatManager.getInteger(noncarrier.getDPBin()),
                FormatManager.getInteger(carrier != null ? carrier.getDPBin() : Data.INTEGER_NA),
                ...
                FormatManager.getFloat(carrier != null ? carrier.getGQ() : Data.FLOAT_NA),
                FormatManager.getFloat(carrier != null ? carrier.getFS() : Data.FLOAT_NA),
                FormatManager.getFloat(carrier != null ? carrier.getMQ() : Data.FLOAT_NA),
                FormatManager.getFloat(carrier != null ? carrier.getQD() : Data.FLOAT_NA),
